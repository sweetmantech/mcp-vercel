    ...
    <div className="max-w-6xl w-full mx-auto relative">
      ...
      <div className="text-center mb-16 relative">
        <div className="inline-flex items-center gap-2 mb-4 glass px-4 py-2 rounded-full">
          ...
          <span className="text-sm font-medium text-gray-300">Live on Mantle Network</span>
        </div>
        ...
        <p className="text-xl text-gray-300 max-w-2xl mx-auto font-light leading-relaxed">
          Connect this mpc server to cursor, claude, t3chat or your preferred ai workspace to discuss your DeFi
          strategies with real-time data from Mantle&apos;s leading protocols.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
        <div className="glass rounded-3xl p-8 relative overflow-hidden">
          ...
          <h2 className="text-2xl font-semibold mb-8 relative">Supported Protocols</h2>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">Leading lending protocol on Mantle</p>
                  </div>
                </div>
              </Link>
            </div>
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400 mt-1">Innovative DEX on Mantle</p>
                  </div>
                </div>
              </Link>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-4 bg-[#252525] p-6 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Live price updates from Mantle Network</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-[#252525] p-6 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Comprehensive TVL and protocol metrics</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 bg-[#252525] p-6 rounded-xl">
              ...
              <div>
                ...
                <p className="text-sm text-gray-400">Deep insights into stablecoin metrics</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="glass rounded-3xl p-8 relative overflow-hidden">
        ...
        <div className="flex items-center justify-between mb-6 relative">
          ...
          <div className="text-sm text-gray-500 font-mono">mcp-config.json</div>
        </div>
